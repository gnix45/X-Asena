...
module.exports = {
  ...
  BRANCH: "main",
  WARN_COUNT: 3,
  PACKNAME: process.env.PACKNAME || "KING-VIEW V1",
  WELCOME_MSG: process.env.WELCOME_MSG || "Hi @user Welcome to @gname",
  GOODBYE_MSG: process.env.GOODBYE_MSG || "Hi @user It was Nice Seeing you",
  AUTHOR: process.env.AUTHOR || "Mr-PK",
  SUDO:
    process.env.SUDO || "237692872730,237675937819",
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || "",
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || "",
  OWNER_NAME: process.env.OWNER_NAME || "Mr PK",
  HEROKU: toBool(process.env.HEROKU) || false,
  BOT_NAME: process.env.BOT_NAME || "KING VIEW V1",
  AUTO_READ: toBool(process.env.AUTO_READ) || true,
  AUTO_STATUS_READ: toBool(process.env.AUTO_STATUS_READ) || true,
  PROCESSNAME: process.env.PROCESSNAME || "pk",
